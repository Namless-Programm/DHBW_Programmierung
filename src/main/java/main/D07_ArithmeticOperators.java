...
public class D07_ArithmeticOperators {
	...
	public static void main(String[] args) {
		...
		int c4 = a / b; // Granzzahlige Division (Quotinet)
		int c5 = a % b; // Ganzzahlige Division (Divisionsrest)
		double c6 = (double) a / b; // Division mit double
		float c7 = (float) a / b; // Division mit Floata

		System.out.println("c1: " + c1);
		System.out.println("c2: " + c2);
		System.out.println("c3: " + c3);
		System.out.println("c4 & c5: " + c4 + "Rest: " + c5);
